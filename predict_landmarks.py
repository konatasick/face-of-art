...
if __name__ == "__main__":
  ...
  out_dir = f'{data_dir}{test_data}-out_pred_landmarks'  # directory for saving predicted landmarks
  ...
  for i, img in enumerate(img_list):
      ...
      preds = heatmap_model.get_landmark_predictions(img_list=[img], pdm_models_dir=pdm_path, clm_model_path=clm_path,
                                                    reuse=tf.AUTO_REUSE, map_to_input_size=map_landmarks_to_original_image)
